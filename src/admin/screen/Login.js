      ...
      <Card sx={{ maxWidth: 400, width: "100%", borderRadius: 3, boxShadow: 5 }}>
        <CardContent sx={{ p: 4 }}>
          <Box textAlign="center" mb={3}>
            ...
            <Typography variant="h5" fontWeight={600} gutterBottom>Admin Login</Typography>
            <Typography variant="body2" color="text.secondary">Enter your credentials to continue</Typography>
          </Box>

          {(contextError || localError) && <Alert severity="error" sx={{ mb: 2 }}>{contextError || localError}</Alert>}
          ...
          <Box component="form" onSubmit={handleSubmit}>
            ...
            <Button type="submit" fullWidth variant="contained" color="primary" startIcon={<LoginIcon />} sx={{ mt: 2, py: 1.5 }} disabled={loading}>
